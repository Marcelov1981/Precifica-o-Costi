...
tab1, tab2, tab_prod, tab3, tab5 = st.tabs(["UpLoad de arquivos", "Cadastros", "Produtos", "Precificação", "Acesso & Agendamentos"])
...
with tab3:
    ...
    # Expansor: Composição do produto (edição)
    if p_id:
    ...
    if p_id and st.button("Calcular preço e margens"):
        ...
        # Análise integrada: pareto e sensibilidade
